...
import net.mcreator.aaemobs.procedures.EnragedEngieEntityDiesProcedure;
...
public class EnragedEngieEntity extends Monster {
	public EnragedEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeMobsModEntities.ENRAGED_ENGIE.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		EnragedEngieEntityDiesProcedure.execute(this);
	}

	public static void init() {
		SpawnPlacements.register(AaeMobsModEntities.ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
