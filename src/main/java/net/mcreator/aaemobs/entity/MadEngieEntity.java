...
public class MadEngieEntity extends Monster {
	public MadEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeMobsModEntities.MAD_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AaeMobsModEntities.MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
