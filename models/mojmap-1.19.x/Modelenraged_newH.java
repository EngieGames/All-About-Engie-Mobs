...
public class Modelenraged_newH<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "enraged_newh"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(32, 0)
						...
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)).texOffs(64, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(14, 59)
						...
						.texOffs(3, 22).addBox(-2.3F, -4.25F, -4.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(3, 22).addBox(1.3F, -4.25F, -4.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
