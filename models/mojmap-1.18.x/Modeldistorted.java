...
public class Modeldistorted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "distorted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(58, 78).mirror()
						.addBox(-4.0F, -4.0F, -1.0F, 8.0F, 8.0F, 2.0F, new CubeDeformation(-2.99F)).mirror(false),
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(104, 16)
				.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r17 = RightArm.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(-1, 55)
						.addBox(-0.8905F, -0.1347F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8905F, -0.1347F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8905F, -0.1347F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8905F, -0.1347F, 1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = RightArm.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(-1, 55)
						.addBox(-0.7178F, -0.4655F, 1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.7178F, -0.4655F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.7178F, -0.4655F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.7178F, -0.4655F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = RightArm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(0, 55)
						.addBox(-0.8241F, -0.8343F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.8241F, -0.8343F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = RightArm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.8368F, -0.5897F, 1.1474F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = RightArm.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.8544F, -0.5723F, -2.144F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.1948F, 10.7332F, 0.0F, -0.192F, 0.0F, 0.0436F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(96, 48)
				.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r22 = LeftArm.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(-1, 55)
						.addBox(-0.8257F, -0.0782F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8257F, -0.0782F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8257F, -0.0782F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(-1, 55)
						.addBox(-0.8257F, -0.0782F, 1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = LeftArm.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(-1, 55)
						.addBox(-0.6321F, -0.4714F, 1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.6321F, -0.4714F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.6321F, -0.4714F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.6321F, -0.4714F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = LeftArm.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(0, 55)
						.addBox(-0.7677F, -0.899F, -1.05F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(-0.7677F, -0.899F, 0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = LeftArm.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.7803F, -0.6533F, 1.1597F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = LeftArm.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.798F, -0.6359F, -2.1564F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2821F, 10.7714F, 0.0F, 2.9496F, 0.0F, 3.098F));
